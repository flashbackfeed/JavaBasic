 ...
 * author : GGG
 * date : 2023-09-26
 * description : Wrapper(포장) 클래스, Boxing/UnBoxing(박스포장/박스뜯기) 예제
 * 요약 :
 *        기본 자료형    : byte, short, int, long, float, double, char, boolean
 *        Wrapper 클래스 : Byte, Short, Integer, Long, Float, Double, Character, Boolean
 *        과거 코딩 :
 *        int(기본자료형) -> Integer(래퍼클래스) 변환 : API 함수를 사용해서 변환했음(Boxing)
 *        int(기본자료형) <- Integer(래퍼클래스) 변환 : API 함수를 사용해서 변환했음(UnBoxing)
 *        현대 코딩 :
 *        자동 변환(함수 사용없이)
 * <p>
 * ===========================================================
