 ...
 *       기본 생성자 : 생성자가 1개도 없을 경우 클래스 선언(정의)시 컴파일러에 의해서 자동으로 추가되는 생성자
 *       (만약에 있을 경우(2nd 생성자 등) 자동 추가 되지 않음)
...
// TODO : 2nd 생성자 함수 : 개발자가 정의하기 나름(매개변수 있고, 리턴값도 있고 자유롭게 정의할 수 있음)
//        **) 생성자 오버로딩 : 같은 이름을 가진 함수를 여러개 정의 할 수 있게 하는 기능 (객체지향언어만 가능)
